...
Le JAR sera dans `target/CompassHotbar-1.5.2.jar`.
...
### v1.5.1
- Amélioration du mode "Kill Outside" pour les zones de jeu
- Meilleure gestion des permissions
- Corrections de bugs

### v1.5.0
- **Nouveau : Menu "Serveurs & Mini-jeux"** sur la boussole
  - Liste des serveurs avec statut en temps réel (ouvert/fermé)
  - Nombre de joueurs en direct
  - Effet brillant sur les serveurs ouverts
  - Transfert vers les serveurs via le proxy
- **Mode "Kill Outside"** : élimine les joueurs qui sortent de la zone
- Système de synchronisation avec le proxy Velocity
- Amélioration de la configuration des items individuels
